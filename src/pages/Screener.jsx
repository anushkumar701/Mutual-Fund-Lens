          ...
          {[
            ...
            >
              ...
              {id === "watchlist" && watchlist.length > 0 && (
                <span className="ml-1.5 bg-amber-400 text-amber-900 text-[10px] rounded-full px-1.5 font-bold">
                  {watchlist.length}
                </span>
              )}
            </button>
            ...
            <div>
              ...
              {cat === "ELSS" && (
                <p className="text-[10px] text-purple-600 dark:text-purple-400 mt-1.5">
                  💡 ELSS = Tax saving under Section 80C. 3 year lock-in. Good
                  returns.
                </p>
              )}
              {cat === "Index" && (
                <p className="text-[10px] text-indigo-600 dark:text-indigo-400 mt-1.5">
                  💡 Index funds track Nifty/Sensex. Very low cost. Best for
                  beginners.
                </p>
              )}
              {cat === "Liquid" && (
                <p className="text-[10px] text-teal-600 dark:text-teal-400 mt-1.5">
                  💡 Liquid funds = safe parking for emergency money. Can
                  withdraw anytime.
                </p>
              )}
            </div>
